...
function getIndexOfAnElementFromHTMLCollection (
    arrayOfHTMLCollection,
    content)
{
...
window.addEventListener('scroll', () =>
{
    ...
    } else if (document.body.getBoundingClientRect().top <
        scrollPos &&
...
if (k3BSubChapterContainers[0] !== null)
{
    k3BSubChapterContainers.forEach((element) =>
    {
        ...
        window.addEventListener('scroll', () =>
        {
            ...
            {
                element.querySelector('.picture-layer').
                    style.opacity = "1";
...
const presentationSlides =
    ...
    dropdownSlides =
        document.querySelectorAll('.dropdown-slide'),
    nextBtn =
        document.querySelector('.next-btn'),
    prevBtn =
        document.querySelector('.prev-btn'),
    dropdownSlidesNextBtn =
        document.querySelector('.dropdown-slide-next-btn'),
    dropdownSlidesPrevBtn =
        document.querySelector('.dropdown-slide-prev-btn');
...
if (dropdownSlidesNextBtn !== null &&
    dropdownSlidesNextBtn !== undefined)
{
...
if (dropdownCarouselToggler !== null &&
    dropdownCarouselToggler !== undefined)
{
