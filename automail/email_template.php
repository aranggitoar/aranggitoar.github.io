			...
			<div style="width: 100%; height: 100%; margin: 0; font: 500 18.4px Garamond, serif; letter-spacing: .015ch; word-spacing: .05ch; color: #333;">
				...
				<div style="font-style: italic; padding-top: 8px; background-color: #ffd249;">
					<div style="width: 100%; max-width: 750px; padding: 0 1rem; margin: 0 auto;">
						<div style="width: 100%; margin-top: 1rem;">
							<img style="display: block; height: 100px; width: 100px; margin: 0 auto;" src="https://benihyangbaik.com/photo/byb-logo-milk-white-transparent.svg" alt="Benih Yang Baik">
						</div>
				...
				<div style="background-color: #fff; border-top: 1px solid #333; border-bottom: 1px solid #333;">
					<div style="width: 100%; max-width: 750px; padding: 0 1rem; margin: 0 auto;">
						...
						<p>Benih Yang Baik menyambut Anda dengan salam hangat dan berterima kasih kepada Anda yang telah bergabung dalam gerakan ini!</p>
						<p>ABBA90 bertujuan untuk meningkatkan daya baca Alkitab di dalam seluruh jemaat Allah, sehingga akan lahir suatu generasi yang menjunjung tinggi Alkitab sebagai Firman Allah.</p>
						<p>'.$which_wave.' ABBA90 akan dimulai pada tanggal '.$start_date.' dan berakhir pada tanggal '.$end_date.'. Setelah Anda menyelesaikan tiga bulan pembacaan Alkitab Perjanjian Baru (PB) dalam versi Terjemahan Sederhana Indonesia (TSI), Anda akan mendapat satu eksemplar Alkitab TSI dan sertifikat.</p>
						<p>Apabila Anda sudah bergabung dalam ABBA90 sebelumnya, Anda akan mendapatkan sertifikat saja.</p>
						<p>Untuk mengikuti ABBA90 Anda dapat mengunduh aplikasi Alkitab multiversi oleh SABDA atau YouVersion melalui Play Store dan App Store bagi pengguna HP Android atau iPhone. Ada juga aplikasi Alkitab khusus versi TSI oleh Global Bible Apps dari Play Store yang dapat <a style="color: #4976FF;" href="https://play.google.com/store/apps/details?id=org.fcbh.inztsi.n2.n">diunduh melalui tautan ini</a>.</p>
						<p>Kalau melalui komputer pribadi atau laptop Anda dapat mengunduh program Alkitab multiversi oleh SABDA melalui <a style="color: #4976FF;" href="www.sabda.net">tautan ini</a>. Atau mengakses YouVersion melalui <a style="color: #4976FF;" href="www.youversion.com">tautan ini</a>.</p>
						<p>Selain itu, Anda akan menjadi anggota grup di WhatsApp atau Telegram untuk saling berbagi dan mendorong dalam petualangan yang hebat dan mulia ini.</p>
						<p>Kemudian, pada tanggal '.$start_date.' kita akan memiliki ibadah pembukaan '.$which_wave.' ABBA90 secara daring untuk peresmian angkatan baru ini.</p>
